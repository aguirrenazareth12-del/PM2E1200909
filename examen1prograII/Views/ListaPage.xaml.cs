...
public partial class ListaPage : ContentPage
{
    ...
    protected override async void OnAppearing()
    {
        ...
        listaSitios.ItemsSource =
            await App.Database.ObtenerSitios();
    }
    ...
    private async void EditarSitio(
        object sender,
        EventArgs e)
    {
        Button btn = (Button)sender;
